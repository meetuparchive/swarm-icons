...
<vector
	...
	android:height="{{iconHeight}}dp"
	android:width="{{iconWidth}}dp"
	android:viewportWidth="{{iconWidth}}"
	android:viewportHeight="{{iconHeight}}"
>
	<path
...
const toAndroidSnakeCase = iconName => iconName
	.replace(/-/g , '_')   // replace hyphens with a '_'
